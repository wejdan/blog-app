...
import { createComment, toggleLikeComment } from "../../services/comments";

export function useLikeComment(onSuccess, onMutationStart, onMutationEnd) {
  const queryClient = useQueryClient();
  const navigate = useNavigate();
  const likeCommentMutation = useAuthMutation(toggleLikeComment, {
    onMutate: async () => {
